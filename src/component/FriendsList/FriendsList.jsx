            ...
            <div className="grid grid-cols-4 gap-4 my-4">
                {friends.map((friend) => (
                    <div className="shadow-[0_0_15px_rgba(0,0,0,0.1)] rounded-sm flex flex-col py-6 px-2 items-center">
                        ...
                        <button className={`px-4 py-1.5 rounded-full mt-4 text-xs font-bold uppercase 
                               ${friend.status === 'on-track' ? 'bg-blue-600 text-white' :
                                friend.status === 'overdue' ? 'bg-red-600 text-white' :
